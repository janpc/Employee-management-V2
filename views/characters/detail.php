    ...
    <section >
        <form action="" method="post" class='infoContainer'>
            <div class='info_column'>
                ...
                <div>
                    <a type="text"  href="<?php echo "http://" . $_SERVER['SERVER_NAME'] . '/employee-management-v2/location/details/' . $this->data['origin_loc']['id'] ?>">></a>
                ...
                <div>
                    <a type="text" name="last_loc" id="last_loc" href="<?php echo "http://" . $_SERVER['SERVER_NAME'] . '/employee-management-v2/location/details/' . $this->data['last_loc']['id'] ?>">></a>
                    <select name="origin_loc" id="origin_loc">
                        <option value="earth">earth</option>
                    </select>
                </div>
