...
<body>
    ...
    <section class='infoSection'>
        ...
        <form action="" method="post" class='infoContainer' id='infoContainer'>
            <div class='info_column'>
                ...
                <label for="episode_no">Gender:</label>
                <input type="number" name="episode_no" id="episode_no" value='<?php echo $this->data->seasonNo ?>'>
